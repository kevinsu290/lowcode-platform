...
var TestEditor = function () {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("div", __assign({ style: { height: "600px", width: "800px" } }, { children: [_jsxs("button", __assign({ onClick: function (e) {
                            return setSerialState(e.target.innerText == "XML" ? "XML" : "JSON");
                        } }, { children: [serialState == "XML" ? "JSON" : "XML", " "] })), _jsx(BlocklyWorkspace, { toolboxConfiguration: toolboxConfiguration, workspaceConfiguration: {
                            grid: {
                                spacing: 20,
                                length: 3,
                                colour: "#ccc",
